...
export const DATA_SOURCES: Record<DataSource | 'all', {name: string; countries: string[]}> = {
  ...
  auu: {
    name: '非洲联盟',
    countries: [
      'dz', 'eg', 'et', 'ao', 'bj', 'bw', 'bf', 'bi', 'gq', 'tg',
      'er', 'cv', 'gm', 'cg', 'cd', 'dj', 'gn', 'gw', 'gh', 'ga',
      'zw', 'cm', 'km', 'ci', 'ke', 'ls', 'lr', 'ly', 'rw', 'mg',
      'mw', 'ml', 'mu', 'mr', 'mz', 'na', 'za', 'ne', 'ng', 'sl',
      'sn', 'sc', 'st', 'sz', 'sd', 'so', 'tz', 'tg', 'tn', 'ug',
      'zm', 'td', 'cf', 'eh', 'ss', 'ma',
    ],
  },
  china_diplomatic: {
    ...
    countries: [
      // 亚洲 (45个国家)
      'af', 'am', 'az', 'bh', 'bd', 'bn', 'kh', 'kp', 'tl', 'ge',
      'in', 'id', 'ir', 'iq', 'il', 'jp', 'jo', 'kz', 'kw', 'kg',
      'la', 'lb', 'my', 'mv', 'mn', 'mm', 'np', 'om', 'pk', 'ps',
      'ph', 'qa', 'kr', 'sa', 'sg', 'lk', 'sy', 'tj', 'th', 'tr',
      'tm', 'ae', 'uz', 'vn', 'ye',
      // 非洲 (53个国家)
      'dz', 'ao', 'bj', 'bw', 'bf', 'bi', 'cm', 'cv', 'cf', 'td',
      'km', 'cd', 'cg', 'ci', 'dj', 'eg', 'gq', 'er', 'et', 'ga',
      'gm', 'gh', 'gn', 'gw', 'ke', 'ls', 'lr', 'ly', 'mg', 'mw',
      'ml', 'mr', 'mu', 'ma', 'mz', 'na', 'za', 'ne', 'ng', 'rw',
      'st', 'sn', 'sc', 'sl', 'so', 'ss', 'sd', 'tz', 'tg', 'tn',
      'ug', 'zm', 'zw',
      // 欧洲 (45个国家)
      ...
      'se', 'ch', 'ua', 'gb',
      // 美洲 (24个国家)
      'ag', 'ar', 'bs', 'bb', 'bo', 'br', 'ca', 'cl', 'co', 'cr',
      'cu', 'dm', 'do', 'ec', 'sv', 'gd', 'gy', 'hn', 'jm', 'mx',
      'ni', 'pa', 'pe', 'sr', 'tt', 'us', 'uy', 've',
      // 大洋洲 (13个国家)
      'au', 'ck', 'fj', 'ki', 'fm', 'nr', 'nz', 'nu', 'pg', 'ws',
      'sb', 'to', 'vu',
    ],
  },
  asiasim: {
